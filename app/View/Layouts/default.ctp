...
<head>
    ...
    <title><?php echo $this->fetch('title'); ?> - Time Tracker</title>
    <?php
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <?php
                    echo $this->Html->link(
                        'Technowise 360 Time Tracker v1.0', 
                        array(
                            'controller' => 'home', 
                            'action' => 'index'), 
                        array(
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <?php
                                echo $this->Html->link(
                                    '<i class="fa fa-dashboard fa-fw"></i> Logs', 
                                    array(
                                        'controller' => 'home', 
                                        'action' => 'logs'), 
                                    array(
                        ...
                        <li>
                            <?php
                                echo $this->Html->link(
                                    '<i class="fa fa-dashboard fa-fw"></i> Attendance', 
                                    array(
                                        'controller' => 'home', 
                                        'action' => 'attendance'), 
                                    array(
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb" id="breadcrumb">
                        <?php
                            echo $this->Html->getCrumbs(' > ', 'Technowise 360', '/admin', false);
                        ?>
                    </ol>
                </div>
            </div>
